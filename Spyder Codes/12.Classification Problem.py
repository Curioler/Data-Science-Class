...
#Tell me one more graph that is useful to check the association
...
#Create a function that will find the total count of flowers of each species
...
#Using random numbers, can you do it? Hint: Use numpy
...
#predict the flower species for y_train
